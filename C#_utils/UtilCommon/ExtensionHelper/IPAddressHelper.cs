...
namespace Util.Common.ExtensionHelper
{
    ...
    public static class IPAddressHelper
    {
        ...
        public static bool IsIPAddress(this string IP)
        {
            ...
            {
                int num;
                if (!int.TryParse(items[i], out num)) return false;
        ...
        {
            if (IP.IsIPAddress() == false) return 0;
        ...
        {
            if (IP.IsIPAddress() == false) return false;
            long address = IP.GetAddress();
            return address > MIN_MULTICASE_ADDRESS && address <= MAX_MULTICASE_ADDRESS;
        }
        private const string min = "224.0.0.255";
        private const string max = "239.255.255.255";
        /// <summary>
        /// 组播最小地址
        /// </summary>
        public static long MIN_MULTICASE_ADDRESS
        {
            get
            {
        ...
        /// 组播最大地址
        /// </summary>
        public static long MAX_MULTICASE_ADDRESS
        {
            get
            {
                return max.GetAddress();
            }
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(msk)) return false;
            ...
            {
                int i;
                if (!int.TryParse(items[j], out i)) return false;
